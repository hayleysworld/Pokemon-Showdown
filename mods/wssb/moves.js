...
exports.BattleMovedex = {
	...
	"noticemesenpai": {
		...
		onHit: function (target, source, move) {
			...
			target.trySetStatus('par', source);
			this.add('raw|<div class="chat"><small>@</small><button name="parseCommand" value="/user viktria" style="background:none;border:0;padding:0 5px 0 0;font-family:Verdana,Helvetica,Arial,sans-serif;font-size:9pt;cursor:pointer"><b><font color="E32AD7">Viktria: </font></b>I knew you\'d fall in love with me eventually!</button><em class="mine"><img src="http://i.imgur.com/Hz4w27G.gif" title="feelskawaii" height="30" width="30" /></em></div>');
		},
		secondary:	{
			boosts: {
				spd: -1,
	...
	"clumsysurgeon": {
		...
		onHit: function (target, source, move) {
			this.add('raw|<div class="chat"><small>%</small><button name="parseCommand" value="/user Chief Sokka" style="background:none;border:0;padding:0 5px 0 0;font-family:Verdana,Helvetica,Arial,sans-serif;font-size:9pt;cursor:pointer"><b><font color="#9B4CCF">Chief Sokka: </font></b>Don\'t worry, I am an expert brain Sergeon!</button><em class="mine"><img src="http://i.imgur.com/gu3Osve.png" title="feelsok" height="30" width="30" /></em></div>');
		},
		secondary: [
			{
				chance: 20,
	...
	"cleanwateract": {
		...
		onHit: function (target, source, move) {
			this.add('raw|<div class="chat"><small>%</small><button name="parseCommand" value="/user SuperJeenius" style="background:none;border:0;padding:0 5px 0 0;font-family:Verdana,Helvetica,Arial,sans-serif;font-size:9pt;cursor:pointer"><b><font color="#1A6CCA">SuperJeenius: </font></b></button>This is a brand new move <em class="mine"><img src="https://cdn.betterttv.net/emote/562b9101a6646e202bcc5447/2x" title="rarechar" height="30" width="30" /></em></div>');
		},
		target: "normal",
		type: "Water",
	},
